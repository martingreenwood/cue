...
final class SpektrixCustomDomainReadiness
{
    ...
    public function customerSession(): ?CustomerSessionData
    {
        ...
        return new CustomerSessionData(
            ...
            membershipsUrl: rtrim($baseUrl, '/').'/api/v3/memberships',
            basketPotentialDiscountUrl: rtrim($baseUrl, '/').'/api/v3/basket/potentialdiscount',
            fundsUrl: rtrim($baseUrl, '/').'/api/v3/funds',
